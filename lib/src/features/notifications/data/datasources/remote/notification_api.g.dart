...
class _NotificationApi implements NotificationApi {
  ...
  @override
  Future<HttpResponse<NotificationsResponse>> getMyNotifications() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<NotificationsResponse>>(
  ...
  Future<HttpResponse<BasicResponse>> editNotification(
    ...
    _data.addAll(params);
    final _options = _setStreamType<HttpResponse<BasicResponse>>(
